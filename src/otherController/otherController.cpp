...
void OtherController::updateState()
{
...
uint8_t OtherController::getScaledAnalogAxis(uint8_t axisPos, uint8_t *minAxis, uint8_t *maxAxis)
{
...
SwitchReport *OtherController::getSwitchReport()
{
